...
class bitget(Exchange):
    ...
    def create_order(self, symbol, type, amount, price=None, match_price=0, order_type=0, params={}):
        self.load_markets()
        market = self.market(symbol)
        request = {
            'instrument_id': market['id'],
    ...
    def fetch_orders(self, symbol=None, status=5, since=None, limit=None, params={}):
        if symbol is None:
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        #  '6': incomplete（open+partially filled),
        #  '7': complete（cancelled+fully filled),
        return self.fetch_orders_by_state('0', symbol, since, limit, params)
