...
class coinsbit(Exchange):
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetTicker(self.extend({'market': market['id']}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        if 'tid' in params:
            ...
            request['since'] = 0
        trades = self.publicGetHistoryResult(self.extend(request, params))
    ...
    def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        if symbol is None:
            raise ArgumentsRequired(self.id + ' fetchOrder requires a symbol argument')
        self.load_markets()
        response = self.privatePostAccountOrderHistory(params)
