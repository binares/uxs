...
class bitpanda(Exchange):
    ...
    def fetch_deposit_address(self, code, params={}):
        ...
        response = self.privateGetAccountDepositCryptoId(self.extend(request, params))
        address = self.safe_string(response, 'address')
        tag = self.safe_string(response, 'destination_tag')
        self.check_address(address)
        return {
    ...
    def fetch_l2_order_book(self, symbol, limit=None, params={}):
        ...
        return self.parse_book(request, params)
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = self.publicGetCandlesticksInstrument(self.extend(request, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetMarketTickerInstrument(self.extend(request, params))
    ...
    def fetch_trading_fees(self, params={}):
        self.load_markets()
        volumeResponse = self.privateGetAccountTradingVolume(params)
        volume = self.safe_float(volumeResponse, 'volume')
        feeResponse = self.privateGetAccountFees(params)
    ...
    def parse_book(self, request, params):
        response = self.publicGetOrderBookInstrument(self.extend(request, params))
