...
TOKENS = {
    "binance": [
        {"id": "binance_withdraw", "trade": False, "apiKey": "abc", "secret": "def"},
        {"id": "binance_withdraw_2", "apiKey": "cba", "secret": "fed"},
    ],
    "kucoin": [
        {
            "id": "kucoin_trade-_withdraw-_test",
            "apiKey": "xxx",
            "secret": "yyy",
            "password": "zzz",
        },
        {
            "id": "kucoin_TRADE-_WITHDRAW-",
            "apiKey": "opq",
            "secret": "rst",
            "password": "123",
        },
...
TEST_AUTH_DATA = [
    ...
    [
        ...
        _entry(
            dict(TOKENS["binance"][0], secret="wrong_secret", id=None),
            False,
            False,
            False,
        ),
