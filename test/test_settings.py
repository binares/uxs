...
from uxs.base._settings import (
    ...
    get_enable_caching,
    set_enable_caching,
    get_enable_caching_for_exchanges,
    set_enable_caching_for_exchanges,
    get_cache_expiry,
    set_cache_expiry,
    get_cache_expiry_for_exchanges,
    set_cache_expiry_for_exchanges,
    clear_setting,
    clear_settings,
    APPDATA_DIR,
    _SETTINGS_INITIAL,
...
def test_set_cache_expiry(init):
    set_cache_expiry(
        {"orderbook": None, "ticker": 10, "markets": 20, "tickers": -1}, True
    )
    set_cache_expiry_for_exchanges(
        {"bitfinex": {"orderbook": 5}, "binance": {"orderbook": -1, "tickers": None}},
        True,
    )
