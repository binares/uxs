        ...
        print(
            "balance: {}".format(
                ...
                if balance is None
                    ...
                    "ETH",
                    balance["free"].get("ETH"),
                    "USDT",
                    balance["free"].get("USDT"),
                ]
            )
        )
...
def test_exchange_init():
    ...
    assert isinstance(e7, ccxt.Exchange) and not isinstance(
        e7, ccxt.async_support.Exchange
    )
    assert e7 is not e1
